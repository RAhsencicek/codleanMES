...
# Broker IP ve port'u ayır (ping ve port testi için)
_broker_parts = BOOTSTRAP.split(":")
BROKER_HOST = _broker_parts[0]
BROKER_PORT = int(_broker_parts[1]) if len(_broker_parts) > 1 else 7001
...
KAFKA_CONFIG = make_config(
    group_id="diagnostic-test",
    session_timeout_ms=6000,
    **{"client.id": "diagnostic-test", "socket.timeout.ms": 5000},
)
